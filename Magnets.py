...
approach_magnet_2 = posx(100, -400, 100, 30, -180, 115)
approach_magnet_3 = posx(100, -500, 350, 30, -180, 115)     # Above magnet place 1
approach_magnet_4 = posx(100, -590, 350, 30, -180, 115)     # Above magnet place 2
pick_magnet = posx(140, -400, 60, 30, -180, 115)            # Pick up position
...
if get_digital_input(1) == 1:       # Wait for a signal to start placing magnets
    place_magnet_1()
    place_magnet_2()
