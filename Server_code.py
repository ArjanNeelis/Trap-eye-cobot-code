...
approach_magnet_1 = posx(350, -303, 400, 0, 180, 90)            # Above magnet storage
approach_magnet_2 = posx(-13, -558, 400, 0, -150, 0)            # Above magnet place 1 angled
approach_magnet_3 = posx(-14, -646, 400, 0, -150, 0)            # Above magnet place 2 angled
approach_magnet_4 = posx(350, -137, 400, 0, 180, 90)            # Move away at an angle
pick_magnet = posx(350, -303, 116, 0, 180, 90)                  # Pick up position
place_position_1a = posx(-12, -558, 351, 0, -150, 0)          # Place position 1st magnet
place_position_1b = posx(-12, -557.5, 351, 0, -150, 0)            # Place position 1st magnet
place_position_2a = posx(-12.5, -643.5, 352, 0, -150, 0)        # Place position 2nd magnet
place_position_2b = posx(-12.5, -644.5, 352, 0, -150, 0)        # Place position 2nd magnet

# ---- Coordinates for pick and place trapezium ----
approach_trapezium_1 = posx(247, -337, 400, 0, 180, 90)         # Above trapezium storage
approach_trapezium_2 = posx(-4, -601.5, 400, 0, -150, 0)        # Above trapezium place
pick_trapezium = posx(247, -337, 152.5, 0, 180, 90)             # Pick up position
place_trapezium = posx(-4, -601.5, 351, 0, -150, 0)             # Place position trapezium

# ---- Coordinates for pick and place screw ----
global screw
screw = 239                                                               # Always start with picking screw 1
...
approach_screw_4 = posx(-230, -400, 246.5, 0, 180, 90)                    # Move around TRAP-EYE
approach_screw_5 = posx(-230, -687.5, 246.5, 0, 180, 90)                  # Move around TRAP-EYE
approach_screw_6 = posx(-190, -687.5, 246.5, 0, 180, 90)                  # Line up with screw hole
place_screw = posx(-175, -687.5, 246.5, 0, 180, 90)                       # Place position trapezium
...
while True:
    ...
    approach_screw_3 = posx(screw, -267, 350, 180, -90, 90)       # Above screw feeder
    pick_screw_1 = posx(screw, -267, 222, 180, -90, 90)           # Pick up position
    pick_screw_2 = posx(screw, -267, 220, 180, -90, 90)           # Pick up position
    # ----------------------------------------------
